...
<template>
  <main>
    ...
    <div class="my-6 sm:my-20 p-4">
      <h1 class="text-2xl md:text-4xl mb-4 font-cardo font-bold">About</h1>
      <p class="text-lg md:text-xl leading-8 text-slate-700 dark:text-gray-300 mb-3">Aku siswa kelas 3 jurusan RPL di <a
      ...
      <p class="md:text-xl leading-8 mb-3 text-slate-700 dark:text-gray-300">Dalam membuat website aku menggunakan <code
    ...
    <div class="my-6 sm:my-20 p-4">
      <h1 class="text-2xl md:text-4xl mb-4 font-cardo font-bold">Get in Touch</h1>
      <p class="mb-4 text-lg md:text-xl text-slate-800 dark:text-gray-200">Reach me via email at <a class="font-semibold"
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        ...
        <a href="https://twitter.com/kholis_hafid" target="_blank">
          <div
            ...
            <p class="text-lg md:text-xl text-slate-700 dark:text-gray-300">@kholis_hafid</p>
          </div>
        </a>
      </div>
    </div>
